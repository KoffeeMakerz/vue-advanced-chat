<template>
	...
	>
		<path
			...
			:stroke="stroke"
			strokeWidth="{1}"
			:transform="svgItem[name].transform"
		/>
	...
	data() {
		return {
			svgItem: {
				...
				timer: {
					path: 'M4.51555 7C3.55827 8.4301 3 10.1499 3 12C3 16.9706 7.02944 21 12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3V6M12 12L8 8'
				}
			}
		}
	},
...
#vac-icon-timer {
	fill: none;
	stroke: var(--chat-icon-color-checkmark);
}
...
#vac-icon-dropup {
	fill: var(--chat-icon-color-dropup);
}
